                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-md-6">
                                    <Link to={'/creator/search'} className="txt active mr-4">SEARCH</Link>
                                    <Link to={'/creator/rainjobs'} className="txt mr-4">RAINJOBS</Link>
                                    <Link to={'/creator/brand'} className="txt mr-4">BRANDS</Link>
                                    <Link to={'/creator/creator'} className="txt mr-4">CREATORS</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="caption-sort d-flex justify-content-between align-items-center pb-2">
                                ...
                                <div className="sort text-steelo-l2 cursor-pointer" onClick={_=>history.push('/creator/rainjobs')}>See more RainJobs</div>
                            </div>
                        ...
                        <div className="col-md-12 mt-4">
                            <div className="caption-sort d-flex justify-content-between align-items-center pb-2">
                                ...
                                <div className="sort text-steelo-l2 cursor-pointer" onClick={_=>history.push('/creator/creator')}>See more creators</div>
                            </div>
                            <div className="row list-job">
                                            ...
                                            <div className="list-a-item p-3">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="fit-info">
                                                        ...
                                                        <div className="c text-blueberry mt-1" onClick={_=>history.push('/creator/view/3')}>PROFILE</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="col-md-12 mt-4">
                            <div className="caption-sort d-flex justify-content-between align-items-center pb-2">
                                ...
                                <div className="sort text-steelo-l2 cursor-pointer" onClick={_=>history.push('/creator/brand')}>See more brands</div>
                            </div>
                            <div className="row list-job">
                                            ...
                                            <div className="list-a-item p-3">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="fit-info">
                                                        <div className="a text-steelo-l2">FIT</div>
                                                        <div className="b text-white mt-1">80%</div>
                                                        <div className="c text-blueberry mt-1" onClick={_=>history.push('/creator/brand/3')}>PROFILE</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default withRouter(connect(mapPropsToState, mapDispatchToProps)(CreatorSearch))