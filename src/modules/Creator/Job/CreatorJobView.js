            ...
            <>
                ...
                <div className="container mt-4">
                    <div className="back-to mt-3">
                        <Link to={'/creator/rainjobs'} className="text-blueberry d-flex align-items-center"><Icon icon="material-symbols:arrow-back-ios-new-rounded" width={12} height={12} className="mr-1" /> Back to Dashboard</Link>
                    </div>
                                ...
                                <div className="view p-3">
                                    <div className="h d-flex align-items-center">
                                        ...
                                        <div className="back flex-fill text-right">
                                            <Link to={'/creator/rainjobs'} className="btn btn-b">Back to RainJobs</Link>
                                        </div>
                                    </div>
