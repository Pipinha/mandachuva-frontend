                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-9">
                                    <Link to={'/creator/view/3'} className="a active">READY TO POST</Link>
                                    <Link to={'/creator/insta/3'} className="a ml-3">MY INSTAGRAM</Link>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default withRouter(connect(mapPropsToState, mapDispatchToProps)(CreatorView))