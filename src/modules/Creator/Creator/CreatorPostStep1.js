...
class CreatorPostStep1 extends Component {
    constructor(props) {
        super(props)
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-9">
                                    <Link to={'/creator/post-step1/3'} className="a">READY TO POST {'>'} REVIEW</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-9 list-job">
                            ...
                            <div className="btns text-right">
                                <Link to={'/creator/post-step2/3'} className="btn btn-a">Continue to Payment</Link>
                            </div>
                        </div>
                    </div>
                </div>
...
export default withRouter(connect(mapPropsToState, mapDispatchToProps)(CreatorPostStep1))