...
class CreatorPostStep2 extends Component {
    constructor(props) {
        super(props)
    ...
    submit(){
        history.push('/creator/post-step3/3')
    }
    render() {
        return (
            <>
...
export default withRouter(connect(mapPropsToState, mapDispatchToProps)(CreatorPostStep2))